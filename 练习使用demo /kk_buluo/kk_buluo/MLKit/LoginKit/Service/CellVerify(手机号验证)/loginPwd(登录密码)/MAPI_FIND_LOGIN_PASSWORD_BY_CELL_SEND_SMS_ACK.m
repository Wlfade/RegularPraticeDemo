//
//  MAPI_FIND_LOGIN_PASSWORD_BY_CELL_SEND_SMS_ACK.m
//  LoginKit
//
...
@interface MAPI_FIND_LOGIN_PASSWORD_BY_CELL_SEND_SMS_ACK ()
/** 手机号 */
@property (nonatomic,copy) NSString *cell;
@end


@implementation MAPI_FIND_LOGIN_PASSWORD_BY_CELL_SEND_SMS_ACK
...
- (void)requestAtView:(UIView *)view mask:(BOOL)mask block:(nullable LoginKitBlock)block {
    ...
    [params setObject:@"FIND_LOGIN_PASSWORD_BY_CELL_SEND_SMS_ACK" forKey:@"service"];
