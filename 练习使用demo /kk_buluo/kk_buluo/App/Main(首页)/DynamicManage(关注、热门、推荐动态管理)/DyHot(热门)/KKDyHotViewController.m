...
#import "KKDyHotViewController.h"
#import "KKDyManagerViewModel.h"
#import "DynamicDetailViewController.h"

@interface KKDyHotViewController ()

@end

@implementation KKDyHotViewController
...
- (void)requsetInfor{
    [KKDyManagerViewModel requestHotSubjectQuery:self.paginator?@(self.paginator.page):@(1) complete:^(NSString * _Nonnull errorStr, ResModel * _Nonnull resultModel, NSMutableArray * _Nonnull resultMutArr) {
