...
#import "Masonry.h"
@implementation KKAccountAlertView
...
//        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(screenOrientationChange) name:NOTIFICATION_DEVICE_ORIENTATION_CHANGED object:nil];//监听屏幕变化
        ...
        [destView.layer setMasksToBounds:YES];
        [destView.layer setCornerRadius:8.0];
        ...
        if (titleString.length > 0 && secondString.length > 0) {
            ...
            [destView addSubview:titleLabel];
            ...
            [destView addSubview:secondLabel];
            
            
            [titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
                make.left.equalTo(destView.mas_left).offset(15);
                make.right.equalTo(destView.mas_right).offset(-15);
                make.top.equalTo(destView.mas_top).offset(40);
        ...
        if (thirdString.length > 0) {
            ...
            [destView addSubview:thirdLabel];
            ...
            [thirdLabel mas_makeConstraints:^(MASConstraintMaker *make) {
                make.left.equalTo(destView.mas_left).offset(15);
                make.right.equalTo(destView.mas_right).offset(-15);
                 make.top.equalTo(destView.mas_top).offset(defaultHeight-70);
                if (titleString.length <= 0 && secondString.length <= 0) {
                    make.top.equalTo(destView.mas_top).offset(defaultHeight-90);
                }
        ...
        [destView addSubview:lline1];
        
        [lline1 mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(destView.mas_left).offset(15);
            make.right.equalTo(destView.mas_right).offset(-15);
            make.top.equalTo(destView.mas_top).offset(defaultHeight-45);
        ...
        [destView addSubview:confirmButton];
