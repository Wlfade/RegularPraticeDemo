...
//---------------------------------------------------
#pragma mark - app
#define RCIM_AppKey @"pvxdm17jpoofr"
...
/** 常用颜色*/
#define COLOR_NAVI_BG           RGB(255, 255, 255)
#define COLOR_BG                RGB(242, 242, 242)
#define COLOR_BLUE              RGB(42, 62, 255)
#define COLOR_LIGHT_BLUE        RGBA(204, 217, 252, 1)
...
#define RELOAD_GROUP_MEMBER @"RELOAD_GROUP_MEMBER"
#define RELOAD_GROUP_NOTICE @"RELOAD_GROUP_NOTICE"
