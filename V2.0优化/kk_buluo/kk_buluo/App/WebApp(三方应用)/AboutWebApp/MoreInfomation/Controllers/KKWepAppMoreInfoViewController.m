...
@interface KKWepAppMoreInfoViewController ()
@property (nonatomic, strong) UITextView *textView;
@end

@implementation KKWepAppMoreInfoViewController
...
- (void)requestWebAppMoreInfoData {
    ...
    [KKWebAppService requestWebAppMoreInfoDataSuccess:^(KKWebAppMoreInfo * _Nonnull moreInfo) {
        NSString *centent = [NSString stringWithFormat:@"%@\n%@\n\n\n%@\n%@\n\n\n%@\n%@\n\n\n%@\n%@\n\n\n%@\n%@\n\n\n%@\n%@\n\n",@"开发者", moreInfo.creator, @"服务及数据由以下网址提供", moreInfo.applicationUrl, @"用户隐私及数据提示", moreInfo.userPrivacy,@"服务类目", moreInfo.catagor, @"名称记录", moreInfo.record, @"服务声明", moreInfo.statement];
