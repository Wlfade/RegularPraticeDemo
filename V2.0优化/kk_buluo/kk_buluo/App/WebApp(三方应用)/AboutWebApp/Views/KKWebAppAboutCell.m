...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        ///
        _webAppDiscriptionLabel = [[UITextView alloc] init];
        _webAppDiscriptionLabel.editable = NO;
        _webAppDiscriptionLabel.top = _webAppNameLabel.bottom + 10;
        ...
        _operationButtonToSend.titleLabel.font = [ccui getRFS:15];
