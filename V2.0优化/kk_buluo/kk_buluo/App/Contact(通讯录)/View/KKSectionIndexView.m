...
@implementation KKSectionIndexView
...
- (void)reloadItemViews
{
    ...
    for (int i = 0; i < numberOfItems; i++) {
        if (_dataSource && [_dataSource respondsToSelector:@selector(sectionIndexView:itemViewForSection:)]) {
            KKSectionIndexItemView *itemView = [_dataSource sectionIndexView:self itemViewForSection:i];
            itemView.section = i;
...
- (void)selectItemViewForSection:(NSInteger)section
{
    ...
    KKSectionIndexItemView *seletedItemView = [self.itemViewList objectAtIndex:section];
...
- (void)highlightItemForSection:(NSInteger)section
{
    ...
    KKSectionIndexItemView *itemView = [self.itemViewList objectAtIndex:section];
...
- (void)unhighlightAllItems
{
    ...
    for (KKSectionIndexItemView *itemView  in self.itemViewList) {
