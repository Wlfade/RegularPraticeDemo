...
- (instancetype)initWithOrigin:(CGPoint)origin Width:(CGFloat)width Height:(CGFloat)height Type:(XTDirectionType)type bgColor:(UIColor *)bgColor cornerRadius:(CGFloat)cornerRadius {
    self = [super initWithOrigin:origin Width:width Height:height Type:type bgColor:bgColor cornerRadius:cornerRadius];
    self.type = type;
    [self setUI:width];
    return self;
}
