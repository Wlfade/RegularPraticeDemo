...
+ (UINavigationController *)getRootNav{
   // return (UINavigationController *)[UIApplication sharedApplication].keyWindow.rootViewController;
    ...
    if ([[AppDelegate sharedAppDelegate].window.rootViewController isKindOfClass:[UINavigationController class]])
    {
        return (UINavigationController *)[AppDelegate sharedAppDelegate].window.rootViewController;
    }
    else if ([[AppDelegate sharedAppDelegate].window.rootViewController isKindOfClass:[UITabBarController class]])
    {
        UIViewController *selectVc = [((UITabBarController *)[AppDelegate sharedAppDelegate].window.rootViewController) selectedViewController];
