//
//  MAPI_FIND_LOGIN_PASSWORD_BY_CELL_VALIDTE_SMS_ACK.m
//  LoginKit
//
...
@interface MAPI_FIND_LOGIN_PASSWORD_BY_CELL_VALIDTE_SMS_ACK ()
/** 手机号 */
...
@implementation MAPI_FIND_LOGIN_PASSWORD_BY_CELL_VALIDTE_SMS_ACK
...
- (void)requestAtView:(UIView *)view mask:(BOOL)mask block:(nullable LoginKitBlock)block {
    ...
    [params setObject:@"FIND_LOGIN_PASSWORD_BY_CELL_VALIDATE_SMS_ACK" forKey:@"service"];
    [params safeSetObject:self.cell forKey:@"cell"];
    [params safeSetObject:self.checkCode forKey:@"validateCode"];
